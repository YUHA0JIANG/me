...
def two_step_ranger(start, stop):
    ...
    """
    return  loop_ranger(start,stop=None,step=2)
...
def stubborn_asker(low, high):
    ...
    while True:
        ...
        if low < num < high:
            ...
            print(f"The number must be between {low} and {high}. Please try again.")
...
def super_asker(low, high):
    ...
    """
    while True:
        num = not_number_rejector(f"Please enter a number between {low} and {high}: ")
        if low < num < high:
            return num
        else:
            print(f"The number must be between {low} and {high}. Please try again.")
